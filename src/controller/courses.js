...
function getCourses() {
  fetch('http://studenter.miun.se/~momo1600/writeable/DT173G/webserver/src/model/courses.php', {
    method: 'GET'
  })
...
function addCourse(e) {
  ...
  fetch('http://studenter.miun.se/~momo1600/writeable/DT173G/webserver/src/model/courses.php', {
    ...
    .then(res => {
      ...
      document.querySelector('.courseform .alert').insertAdjacentHTML(
          'afterbegin',
          '<div style="background-color: green; color: white; padding: 10px; max-width: 500; heigth: auto;">' +
            res.message +
            '</div>'
        );
  ...
  fetch('http://studenter.miun.se/~momo1600/writeable/DT173G/webserver/src/model/courses.php', {
    ...
    .then(res => {
      ...
      document
        ...
        .insertAdjacentHTML(
          'afterbegin',
          '<div style="background-color: red; color: white; padding: 10px; max-width: 500; heigth: auto;">' +
            res.message +
            '</div>'
        );
    })
